...
rubios = sum(hairColorCounts[c("blonde", "blond")])
if (is.na(rubios)){
  rubios=paste("No hay personajes rubios")
}else{
  rubios=paste("Hay ",rubios,"personajes rubios")
}
...
Se analizaron `r n` personajes de la base de datos de star wars.
